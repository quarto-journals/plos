...
author:
  ...
  - name: Fred T. Secondauthor
    affiliations: 
      - "Current address: Some other place, Germany"
  - name: I. Ken Groupleader
    ...
    affiliations: 
      - id: unknown1
        name: Department of Chemistry, Unknown University, Unknown Town
      - id: second-uni
        name: Department of Chemistry, Second University, Nearby Town
    note: A shared note
...
This template file contains some guidelines and recommandation initially noted in `plos_latex_template.tex` that can be found in <https://github.com/quarto-journals/plos/blob/main/style-guide/plos_latex_template.tex>
...
::: {.callout-tips}
This has been made the default in this Quarto format.
...
::: {.callout-note}
Following content of this document is from the LaTeX template content to demo what could be included.
:::
...
Nulla mi mi, @fig-elephant venenatis sed ipsum varius, volutpat euismod diam.
...
Nulla mi mi, venenatis sed ipsum varius, @tab-table1 volutpat euismod diam. 
...
Nulla mi mi, venenatis sed ipsum varius,see @tab-table1
